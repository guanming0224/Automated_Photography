...
class CameraCard(QWidget):
    ...
    def __init__(self, camera_index: int, parent=None):
        ...
        separator.setObjectName("CardDivider")
        separator.setAlignment(Qt.AlignCenter)

        self.last_photo_label = AspectRatioLabel(f"相機 {camera_index} 最後拍攝")
        self.last_photo_label.setObjectName("PreviewSurface")
...
class CircularProgressWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setMinimumSize(CIRCULAR_PROGRESS_SIZE, CIRCULAR_PROGRESS_SIZE)
        ...
        self._color_text = QColor("#172026")
        self._color_muted = QColor("#687981")
    ...
    def paintEvent(self, event):
        ...
        primary_font = QFont("Microsoft JhengHei UI", 13, QFont.Weight.Bold)
        painter.setFont(primary_font)
        painter.setPen(self._color_text)
        painter.drawText(inner.adjusted(0, -18, 0, -2), Qt.AlignCenter, self.photo_text)

        secondary_font = QFont("Microsoft JhengHei UI", 11, QFont.Weight.DemiBold)
        painter.setFont(secondary_font)
        painter.setPen(self._color_muted)
        painter.drawText(inner.adjusted(0, 20, 0, 2), Qt.AlignCenter, self.countdown_text)
